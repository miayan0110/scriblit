...
from dataloader_ex4 import Indoor_dataset, shading2scrib
	...
	for epoch in range(first_epoch, args.num_train_epochs):
		for step, batch in enumerate(train_dataloader):
			with accelerator.accumulate(controlnet):
				...
				# loss = latent_loss + image_loss + 5 * phys_loss + recon_loss + 10 * cond_loss
				loss = latent_loss + image_loss + phys_loss + recon_loss + 10 * cond_loss
