...
from ..conv_encoder_decoder.submodules import Encoder, UpSampleBN, UpSampleGN, \
    INPUT_CHANNELS_DICT, upsample_via_bilinear, upsample_via_mask, get_prediction_head
from ..dsine.submodules import get_pixel_coords, ConvGRU, get_unfold, RayReLU
...
class DSINE_v02(nn.Module):
    def __init__(self):
        ...
        NF = 2048
        BN = False
        down = self.downsample_ratio = 8
        learned_upsampling = True

        self.ps = 5
        self.num_iter_train = 5
        self.num_iter_test = 5
        self.v_relu = True
