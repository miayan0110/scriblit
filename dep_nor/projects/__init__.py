...
def get_default_parser():
    ...
    parser.add_argument('--exp_name', type=str, default='exp001_cvpr2024')
    parser.add_argument('--exp_id', type=str, default='dsine')

    # training
    parser.add_argument('--num_epochs', default=5, type=int)
    parser.add_argument('--batch_size', default=4, type=int)
    parser.add_argument('--accumulate_grad_batches', default=4, type=int, help='accumulate gradient every N batches')
    parser.add_argument("--workers", default=32, type=int)

    parser.add_argument("--distributed", default=False, action="store_true", help="Use DDP if set")
    parser.add_argument('--gpus', type=str, default='0', help='which gpus to use, if -1, use all')
    ...
    parser.add_argument('--diff_lr', default=True, action="store_true", help="use different LR for different network components")
    parser.add_argument('--grad_clip', default=1.0, type=float)

    parser.add_argument('--validate_every', default=20000, type=int, help='validate every N iterations, validation also happens every epoch')
    parser.add_argument('--visualize_every', default=10000, type=int, help='visualize every N iterations')
    ...
    parser.add_argument('--input_height', default=0, type=int)
    parser.add_argument('--input_width', default=0, type=int)
    ...
    parser.add_argument("--data_augmentation_intrins", default=True, action="store_true")
    ...
    parser.add_argument("--data_augmentation_appear", type=int, default=2)
    ...
    parser.add_argument('--ckpt_path', type=str, default='./checkpoints/exp001_cvpr2024/dsine.pt')
